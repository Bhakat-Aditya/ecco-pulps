...
function Footer() {
  ...
  return (
    <footer id="footer" className="bg-forest text-cream/80 border-t border-cream/10">
      <div className="max-w-7xl mx-auto px-6 py-16 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={link.name}>
                  <a
                    href={link.href}
                    className="group inline-flex items-center text-sm font-medium text-cream/70 hover:text-white transition-colors duration-300 no-underline"
                  >
          ...
          <div>
            ...
            <div className="space-y-5">
              <a href="tel:+919547163587" className="block text-base font-semibold text-cream/90 hover:text-white transition-colors duration-300 no-underline group">
              ...
              <a href="mailto:eccopulps.tissue@gmail.com" className="block text-base font-semibold text-cream/90 hover:text-white transition-colors duration-300 no-underline group">
            ...
            <div className="mt-8 flex gap-4">
              <a
                ...
                className="w-10 h-10 rounded-full border border-cream/20 flex items-center justify-center text-cream/60 hover:text-white hover:border-kraft hover:bg-kraft/10 transition-all duration-300 no-underline"
              >
        ...
        <div className="mt-16 pt-8 border-t border-cream/10 flex flex-col md:flex-row justify-between items-center gap-4 text-center md:text-left">
